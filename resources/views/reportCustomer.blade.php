...
<div class="printFactor">
    ...
    <div class="col-12" style="padding-top: 1cm;float: right;text-align: right;direction: rtl">
        <a style="padding-right: 10px">اطلاعات خریدار:</a>
    </div>
    ...
    <div class="col-12"
         style="padding-top: 2cm;float: right;text-align: right;direction: rtl;justify-content: center;display: flex">
        <table style="border-collapse: collapse;width: 95%;text-align: center">
            ...
            <tr>
                <td colspan="4" style="text-align: right;padding-right: 0.5cm;direction: rtl">
                    سرویس کار: {{$customerBuy[count($customerBuy)-1]->serviceMan}}
                </td>
            </tr>
        </table>
    </div>
    <div class="col-12" style="text-align: right; ">
        <p style="padding: 5cm 0.5cm 0cm 0cm">کیلومتر 5 محور اردستان- کاشان، بعد از پلیس راه، داخل مجتمع خدمات رفاهی
            آسمان اردستان</p>
    </div>
    <div class="col-12" style="text-align: right; ">
        <p style="padding: 2cm 0.5cm 0cm 0cm">تلفن: 09939146646</p>
    </div>
